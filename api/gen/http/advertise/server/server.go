...
// New instantiates HTTP handlers for all the advertise service endpoints using
...
func (s *Server) Service() string { return "advertise" }
...
func (s *Server) MethodNames() []string { return advertise.MethodNames[:] }
